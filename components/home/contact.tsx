...
import { Twitter, Github, Linkedin, Loader, Send } from "lucide-react";
      ...
      <div className="mx-auto flex max-w-2xl flex-grow basis-0 flex-col gap-6">
        ...
        <div className="flex justify-center lg:justify-start">
          <div className="flex flex-col gap-4 lg:items-start">
            ...
            >
              <Twitter className="h-6 w-6" /> @CyclingMeetup
            </a>
            <a
              href="#"
              ...
              rel="noopener noreferrer"
            >
              <Github className="h-6 w-6" /> <span>cycling-meetup</span>
            </a>
            <span className="flex items-center gap-2">
              <Linkedin className="h-6 w-6" /> <span>cycling-meetup</span>
            </span>
          </div>
        </div>
      </div>
