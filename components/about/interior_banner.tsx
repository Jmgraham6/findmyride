...
export default function InteriorBanner() {
  ...
  const navLinks = [
    { text: "Start", href: "/", active: false },
    { text: "Our Story", href: "/about", active: true },
  ];
  ...
  return (
    <div className="mt-20 w-full relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        {/* Background image */}
        <img
          src="https://img.b2bpic.net/premium-photo/low-angle-view-biker-couple-cycling-countryside-road_1134-10656.jpg?w=1937"
